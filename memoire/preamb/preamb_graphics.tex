...
\usetikzlibrary{fit, calc, external, fadings, arrows, positioning, angles, quotes, patterns, backgrounds, shapes.geometric, shapes.misc}
...
\pgfplotscreateplotcyclelist{setBW}{
  	black, mark=square*,   mark options ={fill=white}, mark size=1.2pt\\
	black, mark=*,         mark options ={fill=white}, mark size=1.5pt\\
	black, mark=triangle*, mark options ={fill=white}, mark size=1.7pt\\
	black, mark=diamond*,  mark options ={fill=white}, mark size=1.7pt\\
