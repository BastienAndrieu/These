...
%% Commonly used words
\newcommand{\brep}{BRep}
\newcommand{\deuxD}{2{\scshape d}}
\newcommand{\troisD}{3{\scshape d}}
\newcommand{\piecewise}{par~morceaux}
...
\hyphenation{tri-go-no-mé-tri-que}
\hyphenation{tri-go-no-mé-tri-ques}
\hyphenation{or-ga-ni-gram-me}
