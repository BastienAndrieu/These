...
%	\caption{N\oe uds de Chebyshev-Gauss-Lobatto pour $n = 6$ (extrema locaux du polynome $T_6$ sur l'intervalle $\chebinterval$).}
	\caption{N\oe uds de Chebyshev-Gauss-Lobatto (extrema locaux) du polynôme $T_6$.}% sur l'intervalle $\chebinterval$.}
	\label{fig:cgl_nodes}
\end{figure}
...
Ainsi, si $f$ est suffisamment régulière, sa somme partielle $\truncseries{f}{N}$ en est une excellente approximation pour un faible nombre de degrés de liberté.\\
