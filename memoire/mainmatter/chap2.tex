...
Pour de telles fonctions, les séries de Chebyshev convergent très rapidement.%, comme le montre le théorème suivant.
\begin{theoreme}
	Si $f \in \contdiff{m+1}\chebinterval$, %avec $m \in \mathbb{N}$, 
