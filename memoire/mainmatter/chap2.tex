...
Or, si la convergence des coefficients $\hat{f}_n$ est algébrique \eqref{eq:chebyshev_convergence_coef_algebraic}, alors
\begin{equation}
	\norminf{f - \truncseries{f}{N}} 
	= \bigO{N^{1-p}} 
...
\end{equation}
Si, en revanche, la convergence est géométrique \eqref{eq:chebyshev_convergence_coef_geometric}, alors 
\begin{equation}
	\norminf{f - \truncseries{f}{N}} 
	= \bigO{r^{-N}}
