...
%Les crêtes de $\boundary{\solide}$ sont elle-mêmes des variétés différentielles de continuité $\contgeom{1}$ (\ie possède une direction tangente continue) excepté aux coins.
...
\begin{itemize}
	...
	%\item l'ensemble des coins de $\interface$ est un sous-ensemble des sommets de son modèle \brep\ ;
