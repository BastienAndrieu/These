...
\begin{enumerate}
	...
	%\item formaliser la notion d'enveloppe des boules $\EdB{\interface}{\rho} \defini{=} \boundary{\left\{\solide \cup \sphere[\interface][\rho]\right\}}$
	\item formaliser la notion d'enveloppe des boules (EdB) $\EdB{H \subseteq \interface}{\rho} \defini{=} \boundary{ \left( \ball{H}{\rho} \right) }$
	...
	\[
		\implicitEdB{H}(\bx) \defini{=} \min_{\p \in H} \implicitsphere(\bx, \p).
	\]
	Alors,
	\[ 
		\EdB{H}{\rho} 
