...
%	\item (Implicitisation (approchée) : )
	...
	Afin d'identifier toutes les composantes connectées de la courbe d'intersection, il suffit de trouver les points où les branches ouvertes rencontrent le bord d'un des carreaux, ainsi que les paires de points ``collinéaux'' où les carreaux ont des directions normales parallèles.
