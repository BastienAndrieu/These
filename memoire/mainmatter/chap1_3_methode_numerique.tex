...
Entrée : vecteur position $\bx_{i,j}$ et vitesse normale $\nu_{i,j}$ de chaque marqueur lagrangien , pas de temps $\Delta t$ (\ie $\rho = \nu \Delta t$)
\begin{enumerate}
...
\begin{enumerate}
	...
	\end{enumerate}
	\item décrire l'échantillonnage de la courbe s'intersection ($\Right{\bp}$, $\Left{\bp}$ et $\bg$) aux n\oe uds CGL pour le paramètre de Hohmeyer $w = \dotprod{\vrm{p}}{\bg}$
	\begin{enumerate}
