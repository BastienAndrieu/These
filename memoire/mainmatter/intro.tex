...
\begin{figure}
	...
	\def\alp{0.2}%
	\DTLsetseparator{,}%
	\DTLloaddb[noheader,keys={x,y,a}]{verts}{figures/data/fig_brep_verts.dat}%
	\begin{tikzpicture}[x=\imw, y=\imh, 
		...
		\DTLforeach*{verts}{\x=x, \y=y, \a=a}{%
			\pgfmathsetmacro\alpi{1 + (1 - \a)*(\alp - 1)}%
			{\transparent{\alpi}\fill[black] (\x,\y) circle (1.0pt);}%
		}%
	\end{tikzpicture}
	\DTLgdeletedb{verts}%
	\def\imfacew{42mm}
	%\hfill
	\par
	\figbrepface{007}{\imfacew}{0}{0}%\hfill
	\figbrepface{008}{\imfacew}{0}{0}%\hfill
	\figbrepface{002}{\imfacew}{0}{0}%\hfill
	%\par
