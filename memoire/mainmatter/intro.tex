...
\begin{figure}
  ...
  %
%  \vspace{\onelineskip}
%  \null\hfill\parbox{0.49\linewidth}{%
%    \centering
%    \resizebox{\linewidth}{!}{\input{figures/huygens_principle_eos.tikz}}
%    }\hfill
%  \parbox{0.49\linewidth}{%
%    \centering
%    \resizebox{\linewidth}{!}{\input{figures/huygens_principle_eob.tikz}}
%    }\hfill\null
%  \vspace{\onelineskip}%\hrule
%  \null\hfill\parbox[t]{0.49\linewidth}{%
%  	\caption{Principe de Huygens.}%
%  	\label{fig:huygens_eos}%
%  }\hfill
%  \parbox[t]{0.49\linewidth}{%
%    \caption{Avec condition d'entropie.}%
%    \label{fig:huygens_eob}%
%  }\hfill\null
  %
  \hspace*{\fill}
  \subbottom[Enveloppe des sphères.]{
  \resizebox{0.48\linewidth}{!}{  \label{subfig:huygens_principle_eos}\input{figures/huygens_principle_eos.tikz}}
  }
  \hfill
  \subbottom[Enveloppe des boules.]{
  \resizebox{0.48\linewidth}{!}{\label{subfig:huygens_principle_eob}\input{figures/huygens_principle_eob.tikz}}
  }
  \hspace*{\fill}
  \caption{Principe de Huygens.} 
