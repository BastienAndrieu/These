...
\mypart{Première}{Développement d'un outil de suivi de surface adapté aux géométries régulières par morceaux}
\include{mainmatter/chap1_1_formulation_probleme_propagation}

\include{mainmatter/chap1_2_algo_general}

\include{mainmatter/chap1_3_methode_numerique}

\include{mainmatter/chap1_4_validation}
...
%\include{mainmatter/chap4_deformation_maillage}
...
\bibliography{biblio/spectral_chebyshev,biblio/mesh_generation,biblio/mesh_optimization,biblio/cad,biblio/deformable_geometry,biblio/interface_propagation,biblio/intersection,biblio/computational_geometry}
%%%%%%%%%%%%%%%%%
