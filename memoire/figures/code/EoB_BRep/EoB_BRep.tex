...
\begin{figure}
  ...
  %
  \hspace*{\fill}
  \subbottom[Modèle \brep\ de l'interface initiale.]{
	\begin{tikzpicture}
		\figEoBBrep{1}{0}{0}
%		\draw[blue, dashed] 
...
%			(current bounding box.north west) -- cycle;
  ...
  \hspace*{\fill}
  \caption{L'algorithme présenté dans le chapitre a pour but de construire un modèle \brep\ dynamique de l'interface en propagation (à corriger).}
  %
\end{figure}