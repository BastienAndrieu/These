...
\begin{tikzpicture}[
	...
	\begin{scope}[
		...
		\node[colorFace0] at (0.64, 0.31) {$\Sigma_i$};
		\node[colorFace1] at (0.57, 0.455) {$\EdSpropreplus{\Sigma_i}{\rho}$};
		\node[colorFace0!50!black] at (0.35, 0.55) {$\brepface_i$};
		\node[colorFace1, anchor=south, inner sep=0] at (0.355, 0.695) {$\EdSpropreplus{\brepface_i}{\rho}$};
		\node[colorEdS, anchor=west] at (0.81, 0.1) {$\EdS{\Sigma_i}{\rho}$};
	...
	\begin{scope}[
		...
		\node[colorBordDomaineUV] at (-0.2, -0.25) {$\uvdomain_i$};
