...
lineset.name = 'lineset_plane_hid'
lineset.select_silhouette = False
lineset.select_border = True
...
scene.render.filepath = pthimg + 'EdS_propre'
bpy.ops.render.render(write_still=True)



## 2) ENVELOPE (FREESTYLE ONLY)
scene.render.use_freestyle = True
set_dummy_material(EdS)

scene.render.filepath = pthimg + 'EdS_propre_lineart'
bpy.ops.render.render(write_still=True)



## 3) CIRCLE + SPHERE (NO FREESTYLE)
scene.render.use_freestyle = False
sphere.hide_render = False
circle.hide_render = False
EdS.hide_render = True

scene.render.filepath = pthimg + 'sphere_circle'
bpy.ops.render.render(write_still=True)



## 4) CIRCLE + SPHERE (FREESTYLE ONLY)
scene.render.use_freestyle = True
set_dummy_material(sphere)
set_dummy_material(circle)

scene.render.filepath = pthimg + 'sphere_circle_lineart'
bpy.ops.render.render(write_still=True)
################################################
