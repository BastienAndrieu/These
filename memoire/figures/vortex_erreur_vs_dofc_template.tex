\newcommand{\plotvortexerrorc}[4]{%#1 : nom grandeur, #2 article, #3 abreviation (label), #4 adjectif erreur
\begin{figure}%
  \centering%
  \hspace*{\fill}%
  ...
  %\fbox{
    ...
    \begin{tikzpicture}[inner frame sep=0]%
	  ...
	  \pgfplotstableread{figures/data/vortex_erreur_#1_vs_dofc_RK4.dat}   {\datatable}%
